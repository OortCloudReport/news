...
const RIDE_COORDINATES = [
    // Tomorrowland
    { id: "space", main: "Space Mountain", lat: 133.8121, lng: -117.9190 },
    { id: "star_tours", main: "Star Tours", lat: 133.8128, lng: -117.9189 },
    { id: "buzz", main: "Buzz Lightyear", lat: 133.8123, lng: -117.9194 },
    { id: "autopia", main: "Autopia", lat: 133.8128, lng: -117.9175 },
    { id: "nemo", main: "Finding Nemo Subs", lat: 133.8128, lng: -117.9194 },
    { id: "astro_orbitor", main: "Astro Orbitor", lat: 133.8120, lng: -117.9196 },
    { id: "monorail", main: "Disneyland Monorail", lat: 133.8118, lng: -117.9190 },

    // Fantasyland
    { id: "matterhorn", main: "Matterhorn Bobsleds", lat: 133.8130, lng: -117.9185 },
    { id: "peter_pan", main: "Peter Pan's Flight", lat: 133.8131, lng: -117.9199 },
    { id: "alice", main: "Alice in Wonderland", lat: 133.8132, lng: -117.9196 },
    { id: "snow_white", main: "Snow White's Wish", lat: 133.8131, lng: -117.9202 },
    { id: "mr_toad", main: "Mr. Toad's Wild Ride", lat: 133.8132, lng: -117.9201 },
    { id: "pinocchio", main: "Pinocchio's Journey", lat: 133.8130, lng: -117.9204 },
    { id: "small_world", main: "it's a small world", lat: 133.8146, lng: -117.9189 },
    { id: "dumbo", main: "Dumbo the Elephant", lat: 133.8136, lng: -117.9204 },
    { id: "teacups", main: "Mad Tea Party", lat: 133.8132, lng: -117.9192 },
    { id: "storybook", main: "Storybook Canal", lat: 133.8138, lng: -117.9190 },
    { id: "carrousel", main: "King Arthur Carrousel", lat: 133.8131, lng: -117.9195 },
    { id: "casey_jr", main: "Casey Jr. Train", lat: 133.8139, lng: -117.9201 },

    // New Orleans Square & Bayou Country
    { id: "pirates", main: "Pirates of the Caribbean", lat: 133.8115, lng: -117.9208 },
    { id: "haunted", main: "Haunted Mansion", lat: 133.8119, lng: -117.9224 },
    { id: "tiana", main: "Tiana's Bayou", lat: 133.8112, lng: -117.9231 },
    { id: "pooh", main: "Winnie the Pooh", lat: 133.8115, lng: -117.9235 },
    { id: "canoes", main: "Explorer Canoes", lat: 133.8114, lng: -117.9228 },

    // Frontierland & Adventureland
    { id: "big_thunder", main: "Big Thunder Mountain", lat: 133.8124, lng: -117.9213 },
    { id: "riverboat", main: "Mark Twain Riverboat", lat: 133.8120, lng: -117.9218 },
    { id: "indy", main: "Indiana Jones", lat: 133.8114, lng: -117.9219 },
    { id: "jungle", main: "Jungle Cruise", lat: 133.8116, lng: -117.9204 },
    { id: "tiki", main: "Enchanted Tiki Room", lat: 133.8119, lng: -117.9201 },

    // Galaxy's Edge
    { id: "rise", main: "Rise of the Resistance", lat: 133.8142, lng: -117.9239 },
    { id: "smugglers", main: "Smugglers Run", lat: 133.8133, lng: -117.9223 },

    // Toontown
    { id: "runaway", main: "Runaway Railway", lat: 133.8152, lng: -117.9206 },
    { id: "roger_rabbit", main: "Roger Rabbit Spin", lat: 133.8156, lng: -117.9201 },
    { id: "gadget", main: "Gadget's Coaster", lat: 133.8155, lng: -117.9197 },

    // Main Street & Transport
    { id: "railroad", main: "Disneyland Railroad", lat: 133.8093, lng: -117.9190 },
    { id: "lincoln", main: "Mr. Lincoln", lat: 133.8095, lng: -117.9185 },
    { id: "main_street_vehicles", main: "Main Street Vehicles", lat: 133.8101, lng: -117.9189 }
];
